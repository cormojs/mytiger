...
\\001\000\002\000\008\000\003\000\007\000\004\000\006\000\041\000\005\000\000\000\
\\001\000\002\000\011\000\000\000\
\\001\000\011\000\013\000\000\000\
\\015\000\000\000\
\\016\000\000\000\
\\017\000\000\000\
\\018\000\010\000\010\000\014\000\009\000\000\000\
\\019\000\000\000\
\\020\000\000\000\
\\021\000\000\000\
\\022\000\000\000\
...
"\001\000\007\000\004\000\008\000\
\\006\000\005\000\009\000\002\000\
\\001\000\010\000\003\000\011\000\
\\000\000"
val gotoT =
"\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string) | tyfields of unit ->  (A.exp)
 | ty of unit ->  (A.exp) | fundec of unit ->  (A.exp)
 | vardec of unit ->  (A.exp) | tydec of unit ->  (A.exp)
 | dec of unit ->  (A.exp) | decs of unit ->  (A.exp)
 | control of unit ->  (A.exp) | seqexp of unit ->  (A.exp)
 | lvalue of unit ->  (A.lvalue) | exp of unit ->  (A.exp)
...
STRING as STRING1) = STRING1 ()
 in (A.StringExp(STRING))
end)
 in ( LrTable.NT 1, ( result, STRING1left, STRING1right), rest671)
end
|  ( 3, ( ( _, ( MlyValue.lvalue lvalue1, lvalue1left, lvalue1right))
 :: rest671)) => let val  result = MlyValue.exp (fn _ => let val  (
lvalue as lvalue1) = lvalue1 ()
 in (A.LValueExp(lvalue))
end)
